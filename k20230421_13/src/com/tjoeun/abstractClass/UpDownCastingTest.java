...
//	package 접근 권한은 같은 package 에서는 public 처럼 사용되고 다른 package 에서는
//	private 처럼 사용된다.
...
//		변환하는 것을 말한다.
		Base b = sub;
//		b는 부모 클래스 타입의 객체이지만 자식 클래스 타입의 객체가 생성된 주소를 대입했으므로
...
//		이 때, casting 시켜서 대입하면 대입은 가능하고 정상적인 downcasting이 아닌 경우 문법적으로
