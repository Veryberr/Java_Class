...
//		"+" 연산자의 한쪽이라도 문자열이 나오면 문자열을 이어붙이는 문자열 연결 연산자로 사용됨
//		자바는 "+"이 두 가지 용도로 사용
//		"+" 연산자의 양쪽이 모두 숫자일 경우 덧셈 실행
		System.out.println(5 + 3); // 8
		System.out.println(5 + "+"); // 5+
		System.out.println(5 + "+" + 3 + " = " + 5 + 3); // 5 + 3 = 53
		System.out.println(5 + "+" + 3 + " = " + (5 + 3)); // 5 + 3 = 8
		
//		System.out.println(5 + "-" + 3 + " = " + 5 - 3); // error
		System.out.println(5 + "-" + 3 + " = " + (5 - 3));
		
		System.out.println(5 + "*" + 3 + " = " + 5 * 3); // 연산순위 *이 +보다 더 높아서 상관없음
		System.out.println(5 + "/" + 3 + " = " + 5. / 3); // 몫 (실수 / 정수 = 실수)
		System.out.println(5 + "/" + 3 + " = " + 5 / 3.); // 몫 (실수 / 정수 = 실수)
		System.out.println(5 + "/" + 3 + " = " + 5. / 3.); // 몫 (실수 / 실수 = 실수)
		System.out.println(5 + "%" + 3 + " = " + 5 % 3); // 나머지
		// *** 자바는 정수와 정수의 연산은 결과도 정수 ***
...
//		FormatFlagsConversionMismatchException : 변환 및 플래그에 호환성이 없는 경우 발생되는 체크되지 않는 예외
...
//		출력 서식에 "%" 문자 자체를 출력하려면 "%%"와 같이 입력해야 한다.
		System.out.printf("%d %% %d = %d\n", 5, 3, 5 % 3); // 포맷 출력을 위한 특수한 의미로 사용되기 때문
		System.out.println("==========================================");
		
//		출력 서식의 개수보다 데이터가 많으면 남는 데이터는 무시된다.
		System.out.printf("%d + %d\n", 5, 3, 5 + 3);
//		출력 서식의 개수보다 데이터가 적으면 MissingFormatArgumentException이 발생된다.
//		MissingFormatArgumentException : 대응하는 인수가 없는 서식 지시자가 존재하는지, 인수 인덱스가 
//		존재하지 않는 인수를 참조하는 경우에 체크되지 않는 예외
