...
//	1:1 상담원이 배정되고 제품을 살 때 가격의 10%를 할인해주고 보너스 포인트를 5%를 적립한다.
...
//	Customer 클래스에서 상속받은 calcBonus() 메소드는 할인전 금액에 대한 보너스 포인트를 
//	계산하기 때문에 VIP 고객의 할인율이 적용된 실제 구매 금액에 대한 보너스 포인트를 계산할 수 없다.
